...
let x = 0, y = 0, dx = 5, dy = 5, r = 30, color = "#97CBFF";
let x2 = canvas.width, y2 = 0, dx2 = 5, dy2 = 5, r2 = 20, color2 = "#FFFFAA";
...
function draw()
{
	...
	if((x-x2)*(x-x2)+(y-y2)*(y-y2)<=(r+r2)*(r+r2))  [color,color2]=[color2,color];
